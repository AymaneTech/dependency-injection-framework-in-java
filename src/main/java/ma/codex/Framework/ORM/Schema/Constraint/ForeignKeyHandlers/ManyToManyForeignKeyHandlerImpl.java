...
public final class ManyToManyForeignKeyHandlerImpl implements ForeignKeyHandler {
    ...
    public String handle(Definition definition) {
        return String.format("""
                        ...
                        FOREIGN KEY (%s) REFERENCES %s(%s))
                        """, definition.tableName(), definition.columnName(), definition.referencedColumn(),
                definition.columnName(), definition.referencedColumn(), definition.columnName(),
                definition.tableName(), definition.columnName(), definition.referencedColumn(),
                definition.referencedTable(), definition.referencedColumn());
    }
}
